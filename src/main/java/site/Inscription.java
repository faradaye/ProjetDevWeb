...
public class Inscription extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (login != "" && login != null && password != "" && password != null && nom != "" && nom != null && prenom != "" && prenom != null && date_naissance != "" && date_naissance != "0000-00-00" && date_naissance != null) {
            if(!utilisateurDao.loginUtilisateurExiste(login)){
                utilisateurDao.ajouter(new Utilisateur(0, login, password, nom, prenom, Date.valueOf(date_naissance), false));
